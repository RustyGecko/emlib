/***************************************************************************//**
 * @file
 * @brief I2C1 poll based driver for master mode operation on DK.
 * @version 3.20.5
 *******************************************************************************
 * @section License
 ...
 ******************************************************************************/
void I2C1DRV_Init(const I2C_Init_TypeDef *init)
{
  int i;
  ...
  GPIO_PinModeSet(I2C1DRV_SCL_PORT, I2C1DRV_SCL_PIN, gpioModeWiredAndPullUp, 1);
  GPIO_PinModeSet(I2C1DRV_SDA_PORT, I2C1DRV_SDA_PIN, gpioModeWiredAndPullUp, 1);
  ...
  for (i = 0; i < 9; i++)
  {
     ...
     */
    GPIO_PinOutSet(I2C1DRV_SCL_PORT, I2C1DRV_SCL_PIN);
    GPIO_PinOutClear(I2C1DRV_SCL_PORT, I2C1DRV_SCL_PIN);
  }

  /* Enable pins at config location */
  I2C1->ROUTE = I2C_ROUTE_SDAPEN |
                I2C_ROUTE_SCLPEN |
                (I2C1DRV_PORT_LOCATION << _I2C_ROUTE_LOCATION_SHIFT);
 ...
 ******************************************************************************/
I2C_TransferReturn_TypeDef I2C1DRV_Transfer(I2C_TransferSeq_TypeDef *seq)
{
  I2C_TransferReturn_TypeDef ret;
  uint32_t                   timeout = I2C1DRV_TRANSFER_TIMEOUT;
